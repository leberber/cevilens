...
def list_objectifs_in(
    ...
    if code_distributeur:
        join_condition = join_condition & (ObjectifIn.code_distributeur == code_distributeur)

    if edit:
        stmt = base.outerjoin(ObjectifIn, join_condition)
    else:
        stmt = base.join(ObjectifIn, join_condition).where(ObjectifIn.objectif_tonne.isnot(None))
    ...
    return [
        {
            ...
            "nom_distributeur": obj.nom_distributeur if obj else None,
